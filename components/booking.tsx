      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-4xl mx-auto [transform-style:preserve-3d]">
          ...
          <motion.div
            ...
            className="bg-background/80 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.8)] [transform-style:preserve-3d]"
          >
              ...
              <div className="space-y-6" style={{ transform: "translateZ(20px)" }}>
                ...
                <div className="mt-8 md:mt-12 flex justify-end">
                  <button
                    onClick={handleNext}
                    disabled={!service}
                    className="w-full sm:w-auto px-8 py-4 bg-primary text-background font-bold text-sm uppercase tracking-widest rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white transition-colors flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(207,175,108,0.2)]"
                  >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {serviceOptions[service]?.types.map((type) => (
                      <button
                        ...
                        className={`relative overflow-hidden rounded-2xl border text-left transition-all duration-300 transform hover:-translate-y-1 h-32 ${
                          selectedType === type.id 
                            ? 'border-primary shadow-[0_0_20px_rgba(207,175,108,0.4)]' 
                            : 'border-white/10 hover:border-primary/50'
                        }`}
                      >
                        <Image src={type.img} alt={type.label} fill className="absolute inset-0 w-full h-full object-cover opacity-40" referrerPolicy="no-referrer" />
            ...
            {step === 4 && (
              <div className="space-y-8" style={{ transform: "translateZ(20px)" }}>
                ...
                <div className="mt-8 md:mt-12 flex flex-col-reverse sm:flex-row justify-between gap-4">
                  ...
                  <button
                    onClick={handleNext}
                    className="w-full sm:w-auto px-8 py-4 bg-primary text-background font-bold text-sm uppercase tracking-widest rounded-xl hover:bg-white transition-colors flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(207,175,108,0.2)]"
                  >
