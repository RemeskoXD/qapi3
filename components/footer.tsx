    ...
    <footer className="bg-background border-t border-white/5 pt-24 pb-12 relative overflow-hidden [perspective:1000px]">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 [transform-style:preserve-3d]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          {/* Quick Links */}
          <div className="space-y-6 transform transition-transform duration-500 hover:translate-z-10">
            <h4 className="text-sm font-bold text-white uppercase tracking-widest drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">Služby</h4>
          ...
          {/* Company */}
          <div className="space-y-6 transform transition-transform duration-500 hover:translate-z-10">
            <h4 className="text-sm font-bold text-white uppercase tracking-widest drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">Společnost</h4>
            <ul className="space-y-4">
              {[
          ...
          {/* Contact */}
          <div className="space-y-6 transform transition-transform duration-500 hover:translate-z-10">
            <h4 className="text-sm font-bold text-white uppercase tracking-widest drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">Kontakt</h4>
            <ul className="space-y-4">
              <li>
