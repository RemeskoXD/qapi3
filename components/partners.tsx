        ...
        >
          {[...partners, ...partners, ...partners].map((partner, i) => (
            <motion.div
              ...
              className="text-2xl md:text-4xl font-display font-bold text-white/10 tracking-widest uppercase hover:text-primary transition-all duration-500 cursor-default drop-shadow-[0_0_10px_rgba(207,175,108,0)] hover:drop-shadow-[0_0_15px_rgba(207,175,108,0.5)]"
            >
              {partner}
            </motion.div>
          ))}
