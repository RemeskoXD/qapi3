...
export function About() {
  return (
    <section id="o-nas" className="py-32 bg-background relative overflow-hidden border-y border-white/5 [perspective:1000px]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(207,175,108,0.05),transparent_50%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-16 [transform-style:preserve-3d]">
            <div>
              ...
              >
                <span className="w-8 h-[2px] bg-primary shadow-[0_0_10px_rgba(207,175,108,0.8)]" />
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="space-y-5 group p-6 rounded-2xl bg-muted/30 border border-white/5 hover:border-primary/30 hover:bg-muted/80 transition-all duration-500 shadow-lg hover:shadow-[0_10px_30px_rgba(207,175,108,0.15)]"
                  >
                    <div className="w-14 h-14 rounded-xl bg-background flex items-center justify-center border border-white/10 group-hover:border-primary/50 group-hover:bg-primary/10 transition-colors duration-500 shadow-inner">
