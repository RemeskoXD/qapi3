      ...
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col items-center justify-center overflow-hidden px-4 py-20 md:py-24">
        ...
        <div className="relative w-full max-w-[1400px] flex-1 min-h-[200px] bg-[#1a1a1a] border-[8px] md:border-[16px] border-[#2a2a2a] rounded-t-xl md:rounded-t-2xl shadow-2xl overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] to-[#1a1a1a] flex items-center justify-center overflow-hidden">
            ...
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-20 md:h-20 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-1 sm:mb-2 md:mb-4 shadow-[0_0_30px_rgba(207,175,108,0.2)] border border-primary/20">
          ...
          >
            ...
            {[...Array(5)].map((_, i) => (
              ...
              >
                ...
                {i === 3 && (
                  <div className="absolute bottom-2 md:bottom-6 left-1/2 -translate-x-1/2 w-20 md:w-40 h-2 md:h-5 bg-primary rounded-sm shadow-[0_2px_15px_rgba(207,175,108,0.4)] flex items-center justify-center z-20">
        ...
        >
          <Link href="#rezervace" className="group cursor-pointer w-full max-w-xl">
            <div className="relative overflow-hidden rounded-full bg-background/80 backdrop-blur-xl border border-primary/50 p-[1px] shadow-[0_10px_40px_-10px_rgba(207,175,108,0.5)] hover:shadow-[0_20px_60px_-15px_rgba(207,175,108,0.7)] transition-all duration-500 transform hover:-translate-y-1 hover:scale-105">
              <div className="absolute inset-0 bg-gradient-to-r from-primary/30 via-transparent to-primary/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative px-4 py-3 md:px-8 md:py-4 flex items-center justify-between gap-2 md:gap-4 bg-background/90 rounded-full">
                <div className="flex items-center gap-3 md:gap-6">
                  <div className="w-10 h-10 md:w-14 md:h-14 shrink-0 rounded-full bg-primary/20 flex items-center justify-center border border-primary/50 group-hover:rotate-12 transition-transform duration-500 shadow-[0_0_15px_rgba(207,175,108,0.3)]">
                    <Wrench className="w-5 h-5 md:w-7 md:h-7 text-primary" />
                  </div>
                  <div className="text-left flex flex-col sm:flex-row sm:items-center sm:gap-2">
                    ...
                    <span className="hidden sm:inline-block w-1.5 h-1.5 rounded-full bg-primary/50" />
                    <p className="text-primary text-[10px] sm:text-xs md:text-sm font-medium drop-shadow-md">a servis se slevou až 30%</p>
                  </div>
                </div>
