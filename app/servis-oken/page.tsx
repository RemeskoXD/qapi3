    ...
    <main className="flex-1 bg-background">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden [perspective:1000px]">
        ...
        <div className="container relative z-10 px-6 md:px-12 text-center mt-20 [transform-style:preserve-3d]">
          ...
          >
            Servis <span className="text-primary italic font-light">oken</span>
          </motion.h1>
          <motion.p
          ...
          >
            Profesionální údržba, seřízení a opravy pro maximální životnost a funkčnost vašich oken a dveří.
          </motion.p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            ...
            >
              ...
              >
                Okna a dveře vyžadují pravidelnou péči. Správným seřízením a údržbou kování předejdete 
                nákladným opravám, zlepšíte tepelnou izolaci a prodloužíte jejich životnost.
              </motion.p>
